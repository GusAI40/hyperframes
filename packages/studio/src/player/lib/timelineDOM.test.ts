...
describe("parseTimelineFromDOM — hfId from data-hf-id", () => {
  ...
  it("ignores runtime-owned color look canvases with timing attributes", () => {
    const doc = makeDoc(`
      <div data-composition-id="root">
        <img id="photo" class="clip" data-start="0" data-duration="5" />
        <canvas
          class="__hf_color_look_canvas__"
          data-hf-color-look-canvas="true"
...
describe("createImplicitTimelineLayersFromDOM — hfId from data-hf-id", () => {
  ...
  it("ignores runtime-owned color look canvases as implicit layers", () => {
    const doc = makeDoc(`
